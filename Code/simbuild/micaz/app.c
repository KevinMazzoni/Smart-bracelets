...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b67458, const void *arg_0xb7b675f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b188c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79c2840), 
int (*key_eq_fn)(void *arg_0xb79c2c88, void *arg_0xb79c2e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78919b8, int arg_0xb7891b10);
static double RandomUniform(void );
...
typedef TMilli smartBraceletsC$MilliTimer1$precision_tag;
typedef uint16_t smartBraceletsC$Read$val_t;
typedef TMilli smartBraceletsC$MilliTimer2$precision_tag;
typedef TMilli smartBraceletsC$MilliTimer3$precision_tag;
...
typedef TMilli /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef uint16_t /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void smartBraceletsC$SplitControl$startDone(error_t error);
#line 138
static void smartBraceletsC$SplitControl$stopDone(error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void smartBraceletsC$MilliTimer1$fired(void );
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void smartBraceletsC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void smartBraceletsC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void smartBraceletsC$Read$readDone(error_t result, smartBraceletsC$Read$val_t val);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void smartBraceletsC$MilliTimer2$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
smartBraceletsC$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void smartBraceletsC$MilliTimer3$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t smartBraceletsC$SplitControl$start(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void smartBraceletsC$MilliTimer1$startPeriodic(uint32_t dt);
#line 78
static void smartBraceletsC$MilliTimer1$stop(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t smartBraceletsC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t smartBraceletsC$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
smartBraceletsC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t smartBraceletsC$Read$read(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void smartBraceletsC$MilliTimer2$startPeriodic(uint32_t dt);
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t smartBraceletsC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool smartBraceletsC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void smartBraceletsC$MilliTimer3$startPeriodic(uint32_t dt);
#line 78
static void smartBraceletsC$MilliTimer3$stop(void );
# 41 "smartBraceletsC.nc"
uint8_t smartBraceletsC$counter[1000];
uint8_t smartBraceletsC$acks[1000];

uint8_t smartBraceletsC$saved_address[1000];
uint16_t smartBraceletsC$last_x[1000];
uint16_t smartBraceletsC$last_y[1000];
uint8_t *smartBraceletsC$key[1000];

uint8_t smartBraceletsC$kinematic[1000];
uint8_t smartBraceletsC$value_x[1000];
uint8_t smartBraceletsC$value_y[1000];
uint8_t smartBraceletsC$value_kinematic[1000];

uint8_t smartBraceletsC$locked[1000];
uint8_t smartBraceletsC$pairing_done[1000];
uint8_t smartBraceletsC$flag_ACK_requested[1000];

message_t smartBraceletsC$packet[1000];




static void smartBraceletsC$sendPairing(void );
static void smartBraceletsC$sendPairingDone(void );
static void smartBraceletsC$sendInfo(void );
static void smartBraceletsC$fillKeyField(my_msg_t *rcm, char *key);
static bool smartBraceletsC$equalKeys(my_msg_t *rcm, char *secondKey);
...
static void smartBraceletsC$sendInfo(void );
#line 337
static inline void smartBraceletsC$Boot$booted(void );
...
static inline void smartBraceletsC$SplitControl$startDone(error_t err);
#line 362
static inline void smartBraceletsC$SplitControl$stopDone(error_t err);





static inline void smartBraceletsC$MilliTimer1$fired(void );
#line 398
static inline void smartBraceletsC$MilliTimer2$fired(void );
#line 412
static inline void smartBraceletsC$MilliTimer3$fired(void );
#line 426
static void smartBraceletsC$AMSend$sendDone(message_t *buf, error_t err);
#line 461
static inline message_t *smartBraceletsC$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 619
static inline void smartBraceletsC$Read$readDone(error_t result, uint16_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
static inline error_t /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void smartBraceletsC$MilliTimer3$startPeriodic(uint32_t dt){
#line 64
...
inline static void smartBraceletsC$MilliTimer3$stop(void ){
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static uint8_t smartBraceletsC$Packet$payloadLength(message_t * msg){
#line 78
...
#line 475
  if (len != sizeof(my_msg_t )) {
      sim_log_debug(175U, "radio_rec", "Mote %hu received a packet abnormal. Size of this packet: %hu\n", TOS_NODE_ID, len);
      return buf;
    }
  else 
    {
      ...
      sim_log_debug(176U, "radio_rec", "Received packet at time %s at mote %hu\n", sim_time_string(), TOS_NODE_ID);
      sim_log_debug(177U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", smartBraceletsC$Packet$payloadLength(buf));

      sim_log_debug_clear(178U, "radio_pack", "\t\t Payload \n");


      switch (__nesc_ntoh_uint8(rcm->msg_type.nxdata)) {
          case 1: 
            sim_log_debug_clear(179U, "radio_pack", "\t\t msg_type: PAIRING\n");
          break;
          case 2: 
            sim_log_debug_clear(180U, "radio_pack", "\t\t msg_type: INFO\n");
          break;
          default: 
            sim_log_debug_clear(181U, "radio_pack", "\t\t msg_type not recognized, unexpected error. Value: %hhu \n", __nesc_ntoh_uint8(rcm->msg_type.nxdata));
          break;
        }


      sim_log_debug_clear(182U, "radio_pack", "\t\t key: %s \n", rcm->key);


      sim_log_debug_clear(183U, "radio_pack", "\t\t src_address: %hhu \n", __nesc_ntoh_uint8(rcm->src_address.nxdata));


      switch (__nesc_ntoh_uint8(rcm->stop_pairing.nxdata)) {
          case 0: 
            sim_log_debug_clear(184U, "radio_pack", "\t\t stop_pairing: FALSE\n");
          break;
          case 1: 
            sim_log_debug_clear(185U, "radio_pack", "\t\t stop_pairing: TRUE\n");
          break;
          default: 
            sim_log_debug_clear(186U, "radio_pack", "\t\t stop_pairing not recognized, unexpected error. Value: %hhu \n", __nesc_ntoh_uint8(rcm->stop_pairing.nxdata));
          break;
        }


      sim_log_debug_clear(187U, "radio_pack", "\t\t x_coordinate: %hhu \n", __nesc_ntoh_uint8(rcm->x_coordinate.nxdata));


      sim_log_debug_clear(188U, "radio_pack", "\t\t y_coordinate: %hhu \n", __nesc_ntoh_uint8(rcm->y_coordinate.nxdata));


      switch (__nesc_ntoh_uint8(rcm->kinematic_status.nxdata)) {
          case 1: 
            sim_log_debug_clear(189U, "radio_pack", "\t\t kinematic_status: STANDING \n");
          break;
          case 2: 
            sim_log_debug_clear(190U, "radio_pack", "\t\t kinematic_status: WALKING \n");
          break;
          case 3: 
            sim_log_debug_clear(191U, "radio_pack", "\t\t kinematic_status: RUNNING \n");
          break;
          case 4: 
            sim_log_debug_clear(192U, "radio_pack", "\t\t kinematic_status: FALLING \n");
          break;
          default: 
            sim_log_debug_clear(193U, "radio_pack", "\t\t kinematic_status not recognized, unexpected error. Value: %hhu \n", __nesc_ntoh_uint8(rcm->kinematic_status.nxdata));
          break;
        }
      ...
      if (__nesc_ntoh_uint8(rcm->msg_type.nxdata) == 1) {
          if (TOS_NODE_ID == 1 || TOS_NODE_ID == 2) {
              if (smartBraceletsC$equalKeys(rcm, "Avser242bmdGJKEB2J7b")) {
                  smartBraceletsC$saved_address[sim_node()] = __nesc_ntoh_uint8(rcm->src_address.nxdata);
                  if (__nesc_ntoh_uint8(rcm->stop_pairing.nxdata)) {
                      smartBraceletsC$pairing_done[sim_node()] = TRUE;
                      sim_log_debug(194U, "radio", "Pairing done succesfully between mote %hu and mote %hu!\n", __nesc_ntoh_uint8(rcm->src_address.nxdata), TOS_NODE_ID);
                      return buf;
                    }
                  else {
                      sim_log_debug(195U, "radio", "Sending pairing done between mote %hu and mote %hu!\n", __nesc_ntoh_uint8(rcm->src_address.nxdata), TOS_NODE_ID);
                      smartBraceletsC$sendPairingDone();
                      return buf;
                    }
                }
              else {
                  sim_log_error(196U, "radio_pack", "The key received from Mote %hu doesn't match the key stored in Mote %hu\n", __nesc_ntoh_uint8(rcm->src_address.nxdata), TOS_NODE_ID);
                  return buf;
                }
            }
          else {
#line 573
            if (TOS_NODE_ID == 3 || TOS_NODE_ID == 4) {
                if (smartBraceletsC$equalKeys(rcm, "HFdNkJGB432jnGE89W1m")) {
                    smartBraceletsC$saved_address[sim_node()] = __nesc_ntoh_uint8(rcm->src_address.nxdata);
                    if (__nesc_ntoh_uint8(rcm->stop_pairing.nxdata)) {
                        smartBraceletsC$pairing_done[sim_node()] = TRUE;
                        return buf;
                    ...
                    sim_log_error(197U, "radio_pack", "The key received from Mote %hu doesn't match the key stored in Mote %hu\n", __nesc_ntoh_uint8(rcm->src_address.nxdata), TOS_NODE_ID);
                    return buf;
                  }
              }
            else {
                sim_log_error(198U, "radio_pack", "Node ID not in range [1...4], not valid! Node ID: %hu\n", TOS_NODE_ID);
                return buf;
              }
            }
        }
...
#line 596
        if (__nesc_ntoh_uint8(rcm->msg_type.nxdata) == 2) {
            ...
            smartBraceletsC$last_x[sim_node()] = __nesc_ntoh_uint8(rcm->x_coordinate.nxdata);
            smartBraceletsC$last_y[sim_node()] = __nesc_ntoh_uint8(rcm->y_coordinate.nxdata);

            if (__nesc_ntoh_uint8(rcm->kinematic_status.nxdata) == 4) {
                sim_log_debug(199U, "ALARM", "FALL ALARM: THE CHILD %hu FELL!, the position of the children is\n\tX: %hu\n\tY: %hu\n", __nesc_ntoh_uint8(rcm->src_address.nxdata), smartBraceletsC$last_x[sim_node()], smartBraceletsC$last_y[sim_node()]);
              }


            smartBraceletsC$MilliTimer3$stop();
            smartBraceletsC$MilliTimer3$startPeriodic(60000);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7634ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7634ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = smartBraceletsC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7634ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
inline static void * smartBraceletsC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t smartBraceletsC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7480498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7480498, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(200U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(201U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(202U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(203U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7634108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7634108, msg, error);
#line 110
}
#line 110
...
inline static bool smartBraceletsC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 18
{
  /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t smartBraceletsC$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t smartBraceletsC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7632178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7632178, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void smartBraceletsC$MilliTimer1$startPeriodic(uint32_t dt){
#line 64
...
#line 345
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(163U, "radio", "Radio on on node %hu!\n", TOS_NODE_ID);

      smartBraceletsC$MilliTimer1$startPeriodic(1000);

      smartBraceletsC$sendPairing();
    }
  else {
      sim_log_debug(164U, "radio", "Failed booting radio on node %hu!\n", TOS_NODE_ID);
    }
}
...
#line 113
  smartBraceletsC$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 362
{
  sim_log_debug(165U, "radio_send", "Entered in SplitControl.stopDone()\n\n");
  sim_log_debug(166U, "boot", "Radio stopped!\n");
}
...
#line 138
  smartBraceletsC$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  smartBraceletsC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7483a98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7483a98) {
#line 100
    case 0U:
#line 100
      /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7483a98, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77ed650){
#line 75
  switch (arg_0xb77ed650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77ed650);
#line 75
      break;
#line 75
    }
...
#line 75
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void smartBraceletsC$MilliTimer2$startPeriodic(uint32_t dt){
#line 64
...
#line 64
#line 78
inline static void smartBraceletsC$MilliTimer1$stop(void ){
#line 78
...
#line 368
{
  ...
  sim_log_debug(167U, "timer", "Mote %hu, Timer fired, counter is %hu.\n", TOS_NODE_ID, smartBraceletsC$counter[sim_node()]);

  if (smartBraceletsC$locked[sim_node()]) {
#line 375
      return;
    }
  if (smartBraceletsC$pairing_done[sim_node()]) {
      sim_log_debug(168U, "radio_send", "pairing done\n\n");
      smartBraceletsC$MilliTimer1$stop();
      smartBraceletsC$flag_ACK_requested[sim_node()] = TRUE;

      if (TOS_NODE_ID == 2 || TOS_NODE_ID == 4) {
          sim_log_debug(169U, "radio_send", "starting MilliTimer2\n\n");
          smartBraceletsC$MilliTimer2$startPeriodic(10000);
        }
      else {
#line 386
...
#line 412
{
  ...
  sim_log_debug(170U, "ALARM", "MISSING ALARM: THE CHILD %hu DIDN'T SEND HIS POSITION IN THE LAST MINUTE TO MOTE %hu!\nThe last position of the children is\n\tX: %hu\n\tY: %hu", smartBraceletsC$saved_address[sim_node()], TOS_NODE_ID, smartBraceletsC$last_x[sim_node()], smartBraceletsC$last_y[sim_node()]);
}
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
{
#line 631
  smartBraceletsC$value_x[sim_node()] = (uint8_t )((data & 0000000011111111) >> 8);
  smartBraceletsC$value_y[sim_node()] = (uint8_t )(data % 256);
  smartBraceletsC$value_kinematic[sim_node()] = (uint8_t )((smartBraceletsC$value_x[sim_node()] + smartBraceletsC$value_y[sim_node()]) % 256);
}

# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  smartBraceletsC$Read$readDone(result, val);
#line 63
}
#line 63
# 24 "FakeSensorP.nc"
...
#line 24
{
  /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73013a8){
#line 83
  switch (arg_0xb73013a8) {
#line 83
    case 0U:
#line 83
      smartBraceletsC$MilliTimer1$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      smartBraceletsC$MilliTimer2$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      smartBraceletsC$MilliTimer3$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      /*smartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73013a8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(231U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(230U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(227U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(228U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(220U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(210U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(217U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(222U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t smartBraceletsC$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 337
{
  ...
  sim_log_debug(162U, "boot", "Application booted.\n");
  smartBraceletsC$key[sim_node()] = (uint8_t *)malloc(sizeof(uint8_t ) * 21);
  smartBraceletsC$SplitControl$start();
}

# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 60
  smartBraceletsC$Boot$booted();
#line 60
}
#line 60
...
#line 93
{
  ...
  for (smartBraceletsC$counter[sim_node()] = 0; smartBraceletsC$counter[sim_node()] < 21; smartBraceletsC$counter[sim_node()]++) {
      if (!(__nesc_ntoh_uint8(rcm->key[smartBraceletsC$counter[sim_node()]].nxdata) == (uint8_t )secondKey[smartBraceletsC$counter[sim_node()]])) {
          result = FALSE;
          break;
        }
    }
  ...
  if (result == TRUE) {
      sim_log_debug(148U, "radio_send", "the key received is equal to my key\n\n");
    }
  else {
      sim_log_debug(149U, "radio_send", "the key received is different to my key\n\n");
    }
...
#line 198
{
  ...
  my_msg_t *rcm = (my_msg_t *)smartBraceletsC$Packet$getPayload(&smartBraceletsC$packet[sim_node()], sizeof(my_msg_t ));



  if (rcm == (void *)0 || smartBraceletsC$locked[sim_node()]) {
#line 204
      return;
    }
  smartBraceletsC$pairing_done[sim_node()] = TRUE;

  sim_log_debug(154U, "radio", "Pairing done between motes %hu and %hu\n", smartBraceletsC$saved_address[sim_node()], TOS_NODE_ID);

  switch (TOS_NODE_ID) {

      case 1: 
        __nesc_hton_uint8(rcm->msg_type.nxdata, 1);
      smartBraceletsC$fillKeyField(rcm, "Avser242bmdGJKEB2J7b");
      ...
      case 3: 
        __nesc_hton_uint8(rcm->msg_type.nxdata, 1);
      smartBraceletsC$fillKeyField(rcm, "HFdNkJGB432jnGE89W1m");
      ...
      break;
      default: 
        sim_log_error(155U, "pairing", "Mote ID not in range [1...4], Mote ID: %hu not valid, too much motes or too few!\n", TOS_NODE_ID);
      return;
      break;
    }

  if (smartBraceletsC$AMSend$send(smartBraceletsC$saved_address[sim_node()], &smartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(156U, "radio_send", "Sending packet of type PAIRING_DONE from Mote %hu to Mote %hu...\n", TOS_NODE_ID, smartBraceletsC$saved_address[sim_node()]);
      smartBraceletsC$locked[sim_node()] = TRUE;
      sim_log_debug_clear(157U, "radio_send", " at time %s \n", sim_time_string());
    }
}
...
#line 73
{
  ...
  for (smartBraceletsC$counter[sim_node()] = 0; smartBraceletsC$counter[sim_node()] < 21; smartBraceletsC$counter[sim_node()]++) {
      __nesc_hton_uint8(rcm->key[smartBraceletsC$counter[sim_node()]].nxdata, key[smartBraceletsC$counter[sim_node()]]);
    }
...
#line 55
{
  /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*smartBraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
{
#line 439
  if (&smartBraceletsC$packet[sim_node()] == buf) {
      smartBraceletsC$locked[sim_node()] = FALSE;
      sim_log_debug(171U, "radio_send", "Packet from Mote %hu sent...\n", TOS_NODE_ID);
      sim_log_debug_clear(172U, "radio_send", " at time %s \n", sim_time_string());
    }


  if (smartBraceletsC$flag_ACK_requested[sim_node()] && smartBraceletsC$PacketAcknowledgements$wasAcked(&smartBraceletsC$packet[sim_node()])) {
      smartBraceletsC$acks[sim_node()]++;
      sim_log_debug(173U, "ACK", "Packet sent from Mote %hu acknowledged by Mote %hu, acks received at Mote %hu: %hu\n", TOS_NODE_ID, smartBraceletsC$saved_address[sim_node()], TOS_NODE_ID, smartBraceletsC$acks[sim_node()]);
    }
  else {
#line 450
    if (smartBraceletsC$flag_ACK_requested[sim_node()] && !smartBraceletsC$PacketAcknowledgements$wasAcked(&smartBraceletsC$packet[sim_node()])) {
        sim_log_error(174U, "ACK", "Packet sent from Mote %hu not acknowledged by Mote %hu, acks received at Mote %hu: %hu\n", TOS_NODE_ID, smartBraceletsC$saved_address[sim_node()], TOS_NODE_ID, smartBraceletsC$acks[sim_node()]);
...
#line 278
  ...
  smartBraceletsC$Read$read();

  __nesc_hton_uint8(rcm->x_coordinate.nxdata, smartBraceletsC$value_x[sim_node()]);
  __nesc_hton_uint8(rcm->y_coordinate.nxdata, smartBraceletsC$value_y[sim_node()]);

  if (smartBraceletsC$value_kinematic[sim_node()] >= 0 && smartBraceletsC$value_kinematic[sim_node()] <= 76) {
      smartBraceletsC$kinematic[sim_node()] = 1;
    }
  else {
#line 288
    if (smartBraceletsC$value_kinematic[sim_node()] >= 77 && smartBraceletsC$value_kinematic[sim_node()] <= 153) {
        smartBraceletsC$kinematic[sim_node()] = 2;
      }
    else {
#line 291
      if (smartBraceletsC$value_kinematic[sim_node()] >= 154 && smartBraceletsC$value_kinematic[sim_node()] <= 230) {
          smartBraceletsC$kinematic[sim_node()] = 3;
        }
      else {
#line 294
        if (smartBraceletsC$value_kinematic[sim_node()] >= 231 && smartBraceletsC$value_kinematic[sim_node()] <= 255) {
            smartBraceletsC$kinematic[sim_node()] = 4;
          }
        else {
#line 297
          if (smartBraceletsC$value_kinematic[sim_node()] < 0 || smartBraceletsC$value_kinematic[sim_node()] > 255) {
              sim_log_error(158U, "value", "Value read from sensor not valid, value: %f\n", smartBraceletsC$value_kinematic[sim_node()]);
              return;
            }
          }
        }
...
#line 302
  __nesc_hton_uint8(rcm->kinematic_status.nxdata, smartBraceletsC$kinematic[sim_node()]);
...
#line 313
        if (TOS_NODE_ID == 4) {
            ...
            sim_log_error(159U, "value", "value of the mote id reading the sensor not correct. Mote id n. %hu\n", TOS_NODE_ID);
            return;
          }
        }
      if (smartBraceletsC$PacketAcknowledgements$requestAck(&smartBraceletsC$packet[sim_node()]) != SUCCESS) {
#line 324
          return;
        }
      if (smartBraceletsC$AMSend$send(smartBraceletsC$saved_address[sim_node()], &smartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(160U, "radio_send", "Sending packet INFO from mote %hu to mote %hu\n", TOS_NODE_ID, smartBraceletsC$saved_address[sim_node()]);
          smartBraceletsC$locked[sim_node()] = TRUE;
          sim_log_debug_clear(161U, "radio_send", " at time %s \n", sim_time_string());
        }
    }
}
...
#line 285
  ...
  sim_log_debug(219U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(225U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 129
  ...
  switch (TOS_NODE_ID) {
      ...
      case 1: 
        smartBraceletsC$key[sim_node()] = "Avser242bmdGJKEB2J7b";

      __nesc_hton_uint8(rcm->msg_type.nxdata, 1);
      smartBraceletsC$fillKeyField(rcm, "Avser242bmdGJKEB2J7b");
      sim_log_debug(150U, "radio", "key1 filled successfully");
      __nesc_hton_uint8(rcm->src_address.nxdata, 1);
      ...
      break;
      case 3: 
        smartBraceletsC$key[sim_node()] = "HFdNkJGB432jnGE89W1m";
      ...
      break;
      default: 
        sim_log_error(151U, "pairing", "Mote ID not in range [1...4], Mote ID: %hu not valid, too much motes or too few!\n", TOS_NODE_ID);
      return;
      break;
    }
  ...
  if (smartBraceletsC$AMSend$send(AM_BROADCAST_ADDR, &smartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS && !smartBraceletsC$locked[sim_node()]) {
      sim_log_debug(152U, "radio_send", "Sending packet of type PAIRING from Mote %hu in broadcast...\n", TOS_NODE_ID);
      smartBraceletsC$locked[sim_node()] = TRUE;
      sim_log_debug_clear(153U, "radio_send", " at time %s \n", sim_time_string());
    }
}
...
#line 101
      sim_log_debug(205U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(206U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(207U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(208U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(226U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(229U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(218U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "smartBraceletsC$counter"))
  {
    *addr = (uintptr_t)&smartBraceletsC$counter[__nesc_mote];
    *size = sizeof(smartBraceletsC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$acks"))
  {
    *addr = (uintptr_t)&smartBraceletsC$acks[__nesc_mote];
    *size = sizeof(smartBraceletsC$acks[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$saved_address"))
  {
    *addr = (uintptr_t)&smartBraceletsC$saved_address[__nesc_mote];
    *size = sizeof(smartBraceletsC$saved_address[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$last_x"))
  {
    *addr = (uintptr_t)&smartBraceletsC$last_x[__nesc_mote];
    *size = sizeof(smartBraceletsC$last_x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$last_y"))
  {
    *addr = (uintptr_t)&smartBraceletsC$last_y[__nesc_mote];
    *size = sizeof(smartBraceletsC$last_y[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$key"))
  {
    *addr = (uintptr_t)&smartBraceletsC$key[__nesc_mote];
    *size = sizeof(smartBraceletsC$key[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$kinematic"))
  {
    *addr = (uintptr_t)&smartBraceletsC$kinematic[__nesc_mote];
    *size = sizeof(smartBraceletsC$kinematic[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$value_x"))
  {
    *addr = (uintptr_t)&smartBraceletsC$value_x[__nesc_mote];
    *size = sizeof(smartBraceletsC$value_x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$value_y"))
  {
    *addr = (uintptr_t)&smartBraceletsC$value_y[__nesc_mote];
    *size = sizeof(smartBraceletsC$value_y[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$value_kinematic"))
  {
    *addr = (uintptr_t)&smartBraceletsC$value_kinematic[__nesc_mote];
    *size = sizeof(smartBraceletsC$value_kinematic[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$locked"))
  {
    *addr = (uintptr_t)&smartBraceletsC$locked[__nesc_mote];
    *size = sizeof(smartBraceletsC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$pairing_done"))
  {
    *addr = (uintptr_t)&smartBraceletsC$pairing_done[__nesc_mote];
    *size = sizeof(smartBraceletsC$pairing_done[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$flag_ACK_requested"))
  {
    *addr = (uintptr_t)&smartBraceletsC$flag_ACK_requested[__nesc_mote];
    *size = sizeof(smartBraceletsC$flag_ACK_requested[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "smartBraceletsC$packet"))
  {
    *addr = (uintptr_t)&smartBraceletsC$packet[__nesc_mote];
    *size = sizeof(smartBraceletsC$packet[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module smartBraceletsC */
  smartBraceletsC$counter[__nesc_mote] = 0;
  smartBraceletsC$acks[__nesc_mote] = 0;
  memset((void *)&smartBraceletsC$saved_address[__nesc_mote], 0, sizeof smartBraceletsC$saved_address[__nesc_mote]);
  smartBraceletsC$last_x[__nesc_mote] = 0;
  smartBraceletsC$last_y[__nesc_mote] = 0;
  memset((void *)&smartBraceletsC$key[__nesc_mote], 0, sizeof smartBraceletsC$key[__nesc_mote]);
  memset((void *)&smartBraceletsC$kinematic[__nesc_mote], 0, sizeof smartBraceletsC$kinematic[__nesc_mote]);
  memset((void *)&smartBraceletsC$value_x[__nesc_mote], 0, sizeof smartBraceletsC$value_x[__nesc_mote]);
  memset((void *)&smartBraceletsC$value_y[__nesc_mote], 0, sizeof smartBraceletsC$value_y[__nesc_mote]);
  memset((void *)&smartBraceletsC$value_kinematic[__nesc_mote], 0, sizeof smartBraceletsC$value_kinematic[__nesc_mote]);
  smartBraceletsC$locked[__nesc_mote] = FALSE;
  smartBraceletsC$pairing_done[__nesc_mote] = FALSE;
  smartBraceletsC$flag_ACK_requested[__nesc_mote] = FALSE;
  memset((void *)&smartBraceletsC$packet[__nesc_mote], 0, sizeof smartBraceletsC$packet[__nesc_mote]);
